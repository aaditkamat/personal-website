      ...
      create(context) {
        ...
        return {
          ImportSpecifier(node) {
            if (node.imported.name === "getEntryBySlug" && node.parent?.type === "ImportDeclaration" && node.parent.source.value === "astro:content") {
              context.report({
                node,
                messageId: "deprecated"
              });
                  ...
                  context.report({
                    ...
                    fix(fixer) {
                      return fixer.replaceTextRange(
                        ...
                        sourceCode.text.slice(...right.node.range) + sourceCode.text.slice(...left.node.range)
                      );
                    }
                  });
                }
